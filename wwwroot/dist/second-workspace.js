...
`;
  ...
  // ClientApp/second-workspace.js
  var require_second_workspace = __commonJS({
    "ClientApp/second-workspace.js"() {
      init_main_esm2();
      var tabCounter = 1;
      var fxRates = [
      ...
      var FxRatesPanel = class {
        constructor() {
          this.element = document.createElement("div");
          this.element.className = "workspace-panel fx-panel";
        }
        init() {
        ...
        `;
          ...
          fxRates.forEach((rate) => {
            ...
            const directionSymbol = rate.direction === "up" ? "\u25B8" : "\u25B8";
            card.innerHTML = `
                ...
                <div class="fx-card-header">
                    ...
                    <span
                        class="
                            fx-direction
                            ${rate.direction === "up" ? "fx-up" : "fx-down"}">
          ...
          const subTabs = this.element.querySelectorAll(
            ".fx-subtab"
          );
          subTabs.forEach((tab) => {
      ...
      var OrdersPanel = class {
        constructor() {
          this.element = document.createElement("div");
          this.element.className = "workspace-panel orders-panel";
        }
        init() {
          this.element.innerHTML = `
        ...
        `;
          const tableBody = this.element.querySelector(
            ".order-table-body"
          );
          orderRows.forEach((order) => {
            ...
            const sideClass = order.side === "BUY" ? "buy-side" : "sell-side";
      ...
      var VolSurfacePanel = class {
        constructor() {
          this.element = document.createElement("div");
          this.element.className = "workspace-panel vol-panel";
        }
        init() {
          this.element.innerHTML = `
            ...
            <div class="vol-toolbar">
                ...
                <span class="vol-subtitle">
                    ...
                    implied vol \xB7 by delta / tenor
        ...
        `;
          ...
          volRows.forEach((row) => {
            const tenor = document.createElement(
              "span"
            );
            tenor.className = "vol-tenor";
            tenor.textContent = row.tenor;
            grid.appendChild(
              tenor
            );
            row.values.forEach((value) => {
              ...
              cell.className = `vol-cell ${getVolClass(value)}`;
      ...
      var EmptyPanel = class {
        constructor() {
          ...
          this.element.className = "empty-tab-panel";
        }
        init(params) {
          const title = params?.api?.title ?? "Panel";
      ...
      var MenuHeaderAction = class {
        ...
        init() {
          ...
          button.type = "button";
          button.className = "dock-header-button menu-button";
          ...
          button.addEventListener(
            ...
            () => {
              ...
              parameters.containerApi.addPanel({
                id: `second-tab-${Date.now()}-${tabCounter}`,
                component: "empty",
      ...
      var RightHeaderActions = class {
        ...
        init(parameters) {
          const starButton = document.createElement(
            "button"
          );
          starButton.type = "button";
          starButton.className = "dock-header-button";
          starButton.title = "Favourite";
          starButton.textContent = "\u2606";
          starButton.addEventListener(
            "click",
            () => {
              starButton.textContent = starButton.textContent === "\u2606" ? "\u2605" : "\u2606";
            }
          );
          const popoutButton = document.createElement(
            "button"
          );
          popoutButton.type = "button";
          popoutButton.className = "dock-header-button";
          popoutButton.title = "Pop Out";
          popoutButton.textContent = "\u2197";
          const expandButton = document.createElement(
            "button"
          );
          expandButton.type = "button";
          expandButton.className = "dock-header-button";
      ...
      var fxHeight = Math.floor(
        totalHeight * 0.35
      );
      var ordersHeight = Math.floor(
        totalHeight * 0.3
      );
      var volHeight = Math.floor(
        totalHeight * 0.35
      );
      var fxPanel = dockview.addPanel({
        id: "fx-rates",
        component: "fx-rates",
        title: "FX Rates",
        initialHeight: fxHeight,
        minimumHeight: 200
      });
      var ordersPanel = dockview.addPanel({
        id: "orders",
        component: "orders",
        title: "Orders",
        initialHeight: ordersHeight,
        minimumHeight: 180,
        position: {
          referencePanel: fxPanel,
          direction: "below"
        }
      });
      dockview.addPanel({
